...
for script in super-board-run.sh super-board-stop.sh super-board-gh-guard.sh super-board-status.py super-board-wave-plan.sh super-qa-dispatch.sh super-qa-file-bug.sh super-qa-notify.sh; do
